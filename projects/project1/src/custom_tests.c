...
bool test_body_to_tail() {
  ...
  if (!assert_equals_char("output_2", 's', output_2)) {
    return false;
  }
...
bool test_get_next_row() {
  // TODO: Implement this function.
  unsigned int testcase_1_int = 8;
  char testcase_1_char = 'v';
  unsigned int output_1 = get_next_row(testcase_1_int, testcase_1_char);
  if (!assert_equals_unsigned_int("output_1", 9, output_1)) {
    return false;
  }

  unsigned int testcase_2_int = 8;
  char testcase_2_char = '^';
  unsigned int output_2 = get_next_row(testcase_2_int, testcase_2_char);
  if (!assert_equals_unsigned_int("output_2", 7, output_2)) {
    return false;
  }

  unsigned int testcase_3_int = 8;
  char testcase_3_char = 'a';
  unsigned int output_3 = get_next_row(testcase_3_int, testcase_3_char);
  if (!assert_equals_unsigned_int("output_3", 8, output_3)) {
    return false;
  }
  return true;
}
...
bool test_get_next_col() {
  // TODO: Implement this function.
  unsigned int testcase_1_int = 8;
  char testcase_1_char = 'd';
  unsigned int output_1 = get_next_col(testcase_1_int, testcase_1_char);
  if (!assert_equals_unsigned_int("output_1", 9, output_1)) {
    return false;
  }

  unsigned int testcase_2_int = 8;
  char testcase_2_char = 'a';
  unsigned int output_2 = get_next_col(testcase_2_int, testcase_2_char);
  if (!assert_equals_unsigned_int("output_2", 7, output_2)) {
    return false;
  }

  unsigned int testcase_3_int = 8;
  char testcase_3_char = 'w';
  unsigned int output_3 = get_next_col(testcase_3_int, testcase_3_char);
  if (!assert_equals_unsigned_int("output_3", 8, output_3)) {
    return false;
  }
  return true;
